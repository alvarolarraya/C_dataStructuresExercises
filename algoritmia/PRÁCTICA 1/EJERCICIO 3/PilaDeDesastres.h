...
*/
#ifndef ALC_PILADEDESASTRES_H
#define ALC_PILADEDESASTRES_H
#include <stdbool.h>
#include "desastre.h"
#include <stdlib.h>
...
typedef celdaPila* PilaDeDesastres;

void nuevaPila(PilaDeDesastres *);

void apilar(PilaDeDesastres *, desastre);

bool esNulaPila(PilaDeDesastres);

void desapilar(PilaDeDesastres *);

desastre cima(PilaDeDesastres);
#endif
