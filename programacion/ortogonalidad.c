...
/*Este programa recoge dos tablas, las cuales actúan como vectores, y nos dice si son o no ortogonales*/
#include <stdio.h>
#define N 5
...
int main()
{
    ...
    printf("Este programa recoge dos tablas,");
    printf(" las cuales actúan como vectores, ");
    printf("y nos dice si son o no ortogonales\n");
    do
    {
